...
curl http://localhost:9080/ > /tmp/tmp_out.txt
...
curl http://localhost:9080/index.html > /tmp/tmp_out.txt
OUT=`cat /tmp/tmp_out.txt | grep -o "good shit" | wc -l`
...
curl http://localhost:9081/index.html > /tmp/tmp_out.txt
OUT=`cat /tmp/tmp_out.txt | grep -o "good shit" | wc -l`
[ $OUT -eq 1 ] || fail "should be listening on port 9081"
success "should be listening on port 9081"
